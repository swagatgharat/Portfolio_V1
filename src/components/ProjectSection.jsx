...
import { project_assets, project_details } from '../assets/project/project_assets.js';
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-justify max-w-2xl mx-auto mt-5 mb-12"
      >
        Explore a collection of projects showcasing my expertise in designing and developing impactful websites and applicationss that drive digital success.
      </motion.p>
            ...
            >
              <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7 shadow-md select-none">
                ...
                <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition select-none">
                  <img src={project_assets.send} alt="Send" className="w-5" />
                </div>
              </div>
            </motion.div>
          </a>
